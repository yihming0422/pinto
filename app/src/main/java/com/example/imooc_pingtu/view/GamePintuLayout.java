...
import com.example.imooc_pingtu.utils.DataUtils;
import com.example.imooc_pingtu.utils.ImagePiece;
import com.example.imooc_pingtu.utils.ImageSplitterUtil;
...
public class GamePintuLayout extends RelativeLayout implements OnClickListener {
    ...
    private void initBitmap() {
        ...
        mItemBitmaps = DataUtils.splitImage(mBitmap, mColumn);

        // 使用sort完成我们的乱序
        Collections.sort(mItemBitmaps, (a, b) -> Math.random() > 0.5 ? 1 : -1);

    }

    private void getNotDebugBitmap() {
        mBitmap = BitmapFactory.decodeResource(getResources(), DataUtils.createData());
        //setmBitmap(mBitmap);
    }


    private void getDebugBitmap() {
    ...
    private int getRandomints() {
        Integer[] ints = {R.drawable.qq1, R.drawable.qq24, R.drawable.ship, R.drawable.xla,
                R.drawable.qq26, R.drawable.qq23, R.drawable.qq2, R.drawable.qq3, R.drawable.waiwan,
                R.drawable.qq4, R.drawable.qq6, R.drawable.qq7, R.drawable.qq25,
                R.drawable.qq19, R.drawable.qq20, R.drawable.qq21
                , R.drawable.qq8, R.drawable.qq9, R.drawable.qq10,
                R.drawable.qq11, R.drawable.qq12, R.drawable.image
                , R.drawable.qq13, R.drawable.qq14, R.drawable.qq16
                , R.drawable.qq17, R.drawable.qq18, R.drawable.qq22, R.drawable.qq28, R.drawable.qq29
        };
